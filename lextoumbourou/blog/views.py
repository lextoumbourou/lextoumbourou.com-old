...
def filter_by_tag(request, tag_name):
    ...
    return render_to_response(
        'list_articles.html',
        dict(posts=posts, user=request.user, post_list=posts.object_list))
...
def get_slogan():
    ...
    slogs = [
        ...
        'The story of a guy with a long last name',
        'Automation, XBMC, Python, fun and fulfillment',
        'Don\'t feel bad, I probably wouldn\'t read this blog either']
